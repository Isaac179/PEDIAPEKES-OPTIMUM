...
<head>
    ...
    <meta name="Pediapekes-Pediatras en Toluca" content="">
    <meta name="RefillCreativo" content="">
		...
		<div class="style-picker">
			...
			<div class="choose-switcher-box">
				...
				<ul>
					...
					<li><a href="#." class="box-view" id="box_view"><img src="assets/images/boxed.png" alt="Boxed" /></a></li>
				</ul>
			</div>
	...
	<div class="main-container">
		<main>
					...
					<div id="home-slider1" class="rev_slider" data-version="5.3">
						<ul>
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="assets/images/PediaPekesSlider.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
								<div class="tp-caption background-block NotGeneric-Title tp-resizeme rs-parallaxlevel-0" id="slide-layer-1"
									...
									<span class="title-txt" style="font-size: 40px; font-weight:bold;">Pedia</span> Pekes <br><span style="font-weight:bold; font-size: 28px;">Pequeños creciendo saludables</span>
								</div>
							...
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								...
								<div class="tp-caption background-block NotGeneric-Title tp-resizeme rs-parallaxlevel-0" id="slide-layer-3"
									...
									data-paddingleft="[45,45,45,25]"
									style="z-index:3; position:relative; text-transform:uppercase; width: 561px; color:#4c4c4c; height: 221px; font-family: 'Lato', sans-serif; font-weight: 300;">
								<span class="title-txt" style="font-size: 35px; font-weight:bold;">especialistas</span><br><span style="font-weight:bold; font-size: 27px;">en crecimiento y salud infantil.</span>
								</div>
							...
							<li data-transition="zoomout" data-slotamount="default"  data-easein="easeInOut" data-easeout="easeInOut" data-masterspeed="2000" data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7">
								<img src="assets/images/PediaPekesSlider3.jpg" alt="slider" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
			...
			<div class="welcome-section other-services container-fluid no-left-padding no-right-padding">
				...
				<div class="container">
					...
					<div class="section-header">
						<h3>BIENVENIDOS A NUESTRA CLÍNICA</h3>
					</div><!-- Section Header /- -->
					<div class="row">
						<div class="col-md-8 col-sm-12 col-xs-12 our-clinic">
							...
							<?php include("includes/form-cita.php"); ?>
			...
			<!-- Latest News -->
					...
					<?php include("includes/blog-entradas.php")?>
